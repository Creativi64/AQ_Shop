...
# eBay-Modul: 
function extend_ebay_properties_table_58() {
	...
	if (! MagnaDB::gi()->columnExistsInTable('VariationPictures', TABLE_MAGNA_EBAY_PROPERTIES))
		MagnaDB::gi()->query('ALTER TABLE `'.TABLE_MAGNA_EBAY_PROPERTIES.'` ADD COLUMN `VariationPictures`  longtext DEFAULT NULL AFTER `eBayPicturePackPurge`');
...
$functions[] = 'extend_ebay_properties_table_58';
