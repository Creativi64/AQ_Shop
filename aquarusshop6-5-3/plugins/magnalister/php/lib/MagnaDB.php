...
class MagnaDB {
    ...
    protected $tableDescCache = array();
	...
	public function	getTableColumns($table) {
		...
		$columns = $this->getTableDesc($table);
    ...
    public function resetTableCache() {
        $this->tableDescCache = array();
        $this->tableColumnsCache = array();
        $this->columnExistsInTableCache = array();
    }
     ...
     */
    private function getTableDesc($table) {
        if (!isset($this->tableDescCache[$table])) {
            $this->tableDescCache[$table] = $this->fetchArray('DESC '.$table);
        }
    ...
    public function validateDataLength(&$data, $table) {
        $tableDescription = $this->getTableDesc($table);
