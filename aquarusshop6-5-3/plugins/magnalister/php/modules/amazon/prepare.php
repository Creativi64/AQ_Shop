 ...
 *
 * -----------------------------------------------------------------------------
 * $Id: prepare.php 132 2012-10-19 12:39:38Z derpapst $
 *
...
if (!empty($_POST['FullSerializedForm'])) {
	...
	if (array_key_exists('BrowseNodes', $_POST) && is_array($_POST['BrowseNodes'])) {
	    $_POST['BrowseNodes'] = array_values($_POST['BrowseNodes']);
	}
}
