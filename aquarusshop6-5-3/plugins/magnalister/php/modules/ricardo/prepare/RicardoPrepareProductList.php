 ...
 * -----------------------------------------------------------------------------
 */
require_once(DIR_MAGNALISTER_MODULES.'ricardo/classes/MLProductListRicardoAbstract.php');

class RicardoPrepareProductList extends MLProductListRicardoAbstract {
	...
	public function __construct() {
		...
		parent::__construct();
		$this
			->addDependency('MLProductListDependencyRicardoPrepareFormAction', array('selectionname' => $this->getSelectionName()))
			->addDependency('MLProductListDependencyNoVariantsFilter')
			->addDependency('MLProductListDependencyRicardoPrepareStatusFilter')
