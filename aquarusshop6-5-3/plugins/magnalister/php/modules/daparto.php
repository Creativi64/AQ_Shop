...
$_shippingClass = new MagnaShipping();

if (isset($magnaConfig['db'][$_Marketplace.'.shipping.method']) && 
	!$_shippingClass->methodExists($magnaConfig['db'][$_Marketplace.'.shipping.method']) &&
	(strpos($magnaConfig['db'][$_Marketplace.'.shipping.method'], '__ml_') === false)
) {
	unset($magnaConfig['db'][$_Marketplace.'.shipping.method']);
}
...
if (allRequiredConfigKeysAvailable($requiredConfigKeys, $_MagnaSession['mpID'])) {
	...
	$_shippingClass->configure(array(
		'prefferedMethod' => $magnaConfig['db'][$_Marketplace.'.shipping.method'],
		'shippingCountry' => $magnaConfig['db'][$_Marketplace.'.shipping.country'],
		'fallback' => $magnaConfig['db'][$_Marketplace.'.shipping.cost']
	));
