...
class CrowdfoxPrepareProductList extends MLProductList {
	...
	public function __construct() {
		...
		$this
			->addDependency('MLProductListDependencyCrowdfoxPrepareFormAction', array('selectionname' => $this->getSelectionName()))
