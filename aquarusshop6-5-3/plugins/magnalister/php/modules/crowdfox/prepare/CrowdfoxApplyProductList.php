 ...
 * -----------------------------------------------------------------------------
 */
require_once(DIR_MAGNALISTER_MODULES.'crowdfox/classes/MLProductListCrowdfoxAbstract.php');
class CrowdfoxApplyProductList extends MLProductListCrowdfoxAbstract {
	...
	public function __construct() {
		...
		parent::__construct();
		$this
			->addDependency('MLProductListDependencyCrowdfoxApplyFormAction', array('selectionname' => $this->getSelectionName()))
			->addDependency('MLProductListDependencyNoVariantsFilter')
			->addDependency('MLProductListDependencyCrowdfoxPrepareStatusFilter')
		;
	}
	...
	protected function buildQuery(){
		...
		$aCrowdfoxProperties = MagnaDB::gi()->fetchArray("
		...
		parent::buildQuery()->oQuery->where(
			"p.".$sKeyType." NOT IN ('".implode('\' , \'', $aCrowdfoxProperties)."')
		");
		return $this;
	}
