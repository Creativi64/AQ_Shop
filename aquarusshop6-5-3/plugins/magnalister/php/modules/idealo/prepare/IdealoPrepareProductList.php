...
require_once(DIR_MAGNALISTER_MODULES . 'idealo/classes/MLProductListIdealoAbstract.php');

class IdealoPrepareProductList extends MLProductListIdealoAbstract {
    ...
    public function __construct() {
        ...
        parent::__construct();
        $this
            ->addDependency('MLProductListDependencyIdealoPrepareFormAction', array('selectionname' => $this->getSelectionName()))
            ->addDependency('MLProductListDependencyIdealoPrepareStatusFilter')
