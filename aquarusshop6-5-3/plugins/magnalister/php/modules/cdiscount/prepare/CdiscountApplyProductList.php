...
class CdiscountApplyProductList extends MLProductListCdiscountAbstract {
	...
	public function __construct() {
		...
		parent::__construct();
		$this
			->addDependency('MLProductListDependencyCdiscountApplyFormAction', array('selectionname' => $this->getSelectionName()))
	...
	protected function buildQuery(){
		...
		parent::buildQuery()->oQuery->where(
			"p.".$sKeyType." NOT IN ('".implode('\' , \'', $aCdiscountPrepare)."')
		");
		return $this;
	}
