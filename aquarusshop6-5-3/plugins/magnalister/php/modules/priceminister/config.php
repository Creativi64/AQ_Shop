...
getDBConfigValue(array('priceminister.usevariations', 'val'), $this->mpID, true) ? $mpconfig['checkin']['Variations'] ='yes':
	$mpconfig['checkin']['Variations'] ='no';

if (false === getDBConfigValue('priceminister.imagepath', $_MagnaSession['mpID'], false)) {
	...
	setDBConfigValue('priceminister.imagepath', $_MagnaSession['mpID'], $form['prepare']['fields']['imagepath']['default'], true);
}
