    ...
    public function process()
    {
        ...
        <form name="matching" id="matching" action="<?php echo toURL($this->resources['url']) ?>" method="POST"
                    ...
                    <td class="input">
                        <select name="unit[condition_id]" id="condition_id">
                            <?php foreach ($conditions as $condID => $condName) : ?>
                                <option <?php echo $condID == $defaultCondition ? 'selected' : '' ?>
                                    value="<?php echo $condID ?>"><?php echo $condName ?></option>
                            <?php endforeach ?>
                        </select>
                    </td>
                    <td class="info">&nbsp;</td>
            ...
            <table class="matching">
                    ...
                    <tr>
                        <th colspan="5">
                            <div class="title">
                                ...
                                <span>
									[<span
                                        style="color: #ddd;"><?php echo ML_LABEL_ARTICLE_NUMBER ?></span>: <?php echo $product['Model'] ?>
                                    ,
									<span
                                        style="color: #ddd;"><?php echo ML_LABEL_SHOP_PRICE_BRUTTO ?></span>: <?php echo $product['Price'] ?>
                                    ]
								</span>
                            </div>
                            ...
                            <div id="productDetails_<?php echo $product['Id'] ?>" class="productDescBtn"
                                 title="<?php echo ML_LABEL_DETAILS ?>"><?php echo ML_LABEL_DETAILS ?></div>
                        </th>
                    </tr>
                    </tbody>
                ...
                <?php endforeach ?>
                <script type="text/javascript" src="js/marketplaces/priceminister/product_variation_matching.js?<?php echo CLIENT_BUILD_VERSION?>"></script>
                        ...
                        <table>
                            ...
                            <tr>
                                <td class="first_child">
                                    <a href="<?php echo toURL($this->resources['url']) ?>" title="<?php echo ML_BUTTON_LABEL_BACK ?>"
                                       class="ml-button"><?php echo ML_BUTTON_LABEL_BACK ?></a>
                                </td>
                                <td class="last_child">
                                    <input type="submit" class="ml-button" name="saveMatching"
                                           value="<?php echo $currentPage == $totalPages ? ML_BUTTON_LABEL_SAVE_DATA : ML_BUTTON_LABEL_SAVE_AND_NEXT ?>"/>
                                </td>
                            </tr>
                            </tbody>
                        </table>
    ...
    private function renderDetailView($product)
    {
        ...
        <table class="matchingDetailInfo">
            ...
            <?php if (empty($product['Description']) === false) : ?>
                ...
                <tr class="desc">
                    <td colspan="2">
                        <div class="mlDesc"><?php echo $product['Description'] ?></div>
                    </td>
                </tr>
            <?php endif ?>
