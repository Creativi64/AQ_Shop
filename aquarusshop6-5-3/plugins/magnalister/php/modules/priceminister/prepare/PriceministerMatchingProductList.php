...
class PriceministerMatchingProductList extends MLProductListPriceministerAbstract {
	...
	public function __construct() {	
		...
		parent::__construct();
		$this
			->addDependency('MLProductListDependencyPriceministerMatchingFormAction', array('selectionname' => $this->getSelectionName()))
	...
	protected function buildQuery(){
		...
		parent::buildQuery()->oQuery->where("p.".$sKeyType." NOT IN ('".implode('\' , \'', $aPriceministerProperties)."')");
		return $this;
	}
