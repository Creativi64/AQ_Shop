...
class PriceministerPrepareProductList extends MLProductList {
	...
	public function __construct() {
		...
		$this
			->addDependency('MLProductListDependencyPriceministerPrepareFormAction', array('selectionname' => $this->getSelectionName()))
