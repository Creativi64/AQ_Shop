 ...
 *
 * -----------------------------------------------------------------------------
 * $Id: Ayn24SummaryView.php 1314 2011-10-20 16:44:16Z derpapst $
 *
...
class Ayn24SummaryView extends SimpleSummaryView {
	...
	protected function getAdditionalHeadlines() {
		return '<td title="'.ML_LABEL_BRUTTO.'">'.$this->provideResetFunction(
					ML_AYN24_LABEL_MP_PRICE_SHORT.' <span class="small">'.
		...
		return '
				<td><table class="nostyle"><tbody>
						<tr><td>'.ML_LABEL_NEW.':&nbsp;</td><td>
							'.$this->simplePrice->setPrice($this->selection[$dbRow['products_id']]['price'])->formatWOCurrency().'
