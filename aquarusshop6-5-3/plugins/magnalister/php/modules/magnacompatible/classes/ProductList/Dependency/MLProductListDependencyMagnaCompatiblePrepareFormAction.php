...
class MLProductListDependencyMagnaCompatiblePrepareFormAction extends MLProductListDependency {
	public function getActionBottomLeftTemplate(){
		return 'magnacompatibleprepareformleft';
	}
	
	public function getActionBottomRightTemplate(){
		return 'magnacompatibleprepareformright';
	}
