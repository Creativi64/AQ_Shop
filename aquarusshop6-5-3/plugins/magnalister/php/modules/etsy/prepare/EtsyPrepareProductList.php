...
class EtsyPrepareProductList extends MLProductListEtsyAbstract {
	...
	public function __construct() {
		...
		parent::__construct();
		$this
			->addDependency('MLProductListDependencyEtsyPrepareFormAction', array('selectionname' => $this->getSelectionName()))
			->addDependency('MLProductListDependencyEtsyPrepareStatusFilter')
		;
	}
