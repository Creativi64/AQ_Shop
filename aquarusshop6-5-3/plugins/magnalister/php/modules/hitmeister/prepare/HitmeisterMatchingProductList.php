...
class HitmeisterMatchingProductList extends MLProductListHitmeisterAbstract {
	...
	public function __construct() {	
		...
		parent::__construct();
		$this
			->addDependency('MLProductListDependencyHitmeisterMatchingFormAction', array('selectionname' => $this->getSelectionName()))
	...
	protected function buildQuery(){
		...
		parent::buildQuery()->oQuery->where("p.".$sKeyType." NOT IN ('".implode('\' , \'', MagnaDB::gi()->escape($aHitmeisterProperties))."')");
		return $this;
	}
