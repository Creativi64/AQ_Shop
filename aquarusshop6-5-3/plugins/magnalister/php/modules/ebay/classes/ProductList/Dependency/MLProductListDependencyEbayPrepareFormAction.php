...
//      return $this->resetPartly(array('Description', 'PictureURL', 'VariationPictures'));
//  }
	...
	protected function resetPartly($aParts) {
		if (empty($aParts)) {
			...
			foreach ($aParts as $sPart) {
				$aUpdateCols[$sPart] = '';
				if ('PictureURL' == $sPart) $aUpdateCols[$sPart] = NULL;
				else if ('VariationPictures' == $sPart) $aUpdateCols[$sPart] = NULL;
				else if ('eBayPicturePackPurge' == $sPart) $aUpdateCols[$sPart] = '1';
	...
	public function executeAction() {
		...
		if (isset($aRequest['unprepare'])) {
			...
			if (isset($aRequest['resetPictures'])) {
				...
				$aPartsToReset[] = 'VariationPictures';
				$aPartsToReset[] = 'eBayPicturePackPurge';
			}
