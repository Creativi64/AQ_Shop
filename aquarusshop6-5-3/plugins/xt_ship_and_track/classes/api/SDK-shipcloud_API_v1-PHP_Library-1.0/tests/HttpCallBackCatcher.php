...
class HttpCallBackCatcher extends HttpCallBack {
    ...
    /**
     * Http request
     * @var ShipcloudAPIV1Lib\Http\HttpRequest
     */
    private $request;

    /**
     * Http Response
     * @var ShipcloudAPIV1Lib\Http\HttpResponse
     */
    private $response;
     ...
     * @return ShipcloudAPIV1Lib\Http\HttpRequest
     */
     ...
     * @return ShipcloudAPIV1Lib\Http\HttpResponse
     */
