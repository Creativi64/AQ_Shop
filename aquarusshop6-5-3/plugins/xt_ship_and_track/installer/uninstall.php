...
$db->Execute("DELETE FROM ".TABLE_ADMIN_NAVIGATION." WHERE text like '%shipcloud%'");
...
$db->Execute("DROP TABLE IF EXISTS ".TABLE_SHIPCLOUD_LABELS);
$db->Execute("DROP TABLE IF EXISTS ".TABLE_SHIPCLOUD_COLLECT);
$db->Execute("DROP TABLE IF EXISTS ".TABLE_SHIPCLOUD_SETTINGS);
$db->Execute("DROP TABLE IF EXISTS ".TABLE_SHIPCLOUD_CARRIERS);
$db->Execute("DROP TABLE IF EXISTS ".TABLE_SHIPCLOUD_PACKAGES);
