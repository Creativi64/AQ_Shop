 ...
 * @subpackage Compiler
 */
class Smarty_Internal_Compile_Include_Xt //extends Smarty_Internal_Compile_Include
{
    /**
    ...
    public function compile($args, Smarty_Internal_SmartyTemplateCompiler $compiler)
    {
        ...
        {
            if (file_exists(constant('_SRV_WEBROOT') . _SRV_WEB_TEMPLATES . constant('_SYSTEM_TEMPLATE') . '/.' . $_file))
            {
