...
class export_categories extends xt_backend_cls
{
    ...
    function __construct ()
    {
        ...
        $this->nodeUrl = 'adminHandler.php?load_section=export_categories&sec='. $_SESSION['admin_user']['admin_key'].'&pg=getNode&';
        $this->saveUrl = 'adminHandler.php?load_section=export_categories&sec='. $_SESSION['admin_user']['admin_key'].'&pg=setData&';
    }
    ...
    function getTreePanel ()
    {
        ...
        $tp->setTitle(__text('TABTEXT_CATEGORY'))->setBaseCssClass('xt-filter-panel')
            ->setRoot($root)
            ->setLoader($tl)
            ->setAutoScroll(true)
            ->setAutoWidth(true);
