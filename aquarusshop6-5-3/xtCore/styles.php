...
if(constant('_SYSTEM_USE_WYSIWYG') == 'froala')
{
    ...
    echo '
        <link href="https://cdn.jsdelivr.net/npm/froala-editor@'. FROALA_CDN_VERSION.'/css/froala_editor.pkgd.min.css" rel="stylesheet" type="text/css" />
        ';
