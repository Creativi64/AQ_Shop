...
/**
 * System DeliveryTimes zurückgeben
 * @global type $store_handler
 * @global type $db
 * @global type $system_status
 * @param type $user
 * @param type $pass
 * @return type
 */
function getDeliveryTimes($user, $pass) {
       global $db;
    ...
    try {
        ...
        // DB Abfrage: Tabelle status
       
        $rs = $db->Execute("SELECT sd.status_id,sddesc.status_name FROM " . TABLE_SYSTEM_STATUS . " sd, " . TABLE_SYSTEM_STATUS_DESCRIPTION . " sddesc WHERE sd.status_class='shipping_status' and sddesc.status_id=sd.status_id and sddesc.language_code='de'");
