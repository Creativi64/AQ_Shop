...
//           $js = "var coupon_id = record.id;";
        ...
        ($plugin_code = $xtPlugin->PluginCode('class.xt_coupons_token.php:_getParams_bottom')) ? eval($plugin_code) : false;
...
//       return $js;       
    ...
    function _get($ID = 0) {
        ...
        $table_data = new adminDB_DataRead($this->_table, $this->_table_lang, $this->_table_seo, $this->_master_key,$where,'','','', ' ORDER BY coupons_token_id DESC ');
