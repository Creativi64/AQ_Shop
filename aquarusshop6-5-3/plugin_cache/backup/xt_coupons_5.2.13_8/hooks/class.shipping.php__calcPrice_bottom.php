...
if ($_REQUEST['tmp_coupon'] && ($_REQUEST['tmp_coupon']['coupon_free_shipping'] == '1' || ($_REQUEST['tmp_coupon']['coupon_percent'] == '100' && $_REQUEST['tmp_coupon']['coupon_free_on_100_status'] == '1')) && !empty($shipping_price))
{
