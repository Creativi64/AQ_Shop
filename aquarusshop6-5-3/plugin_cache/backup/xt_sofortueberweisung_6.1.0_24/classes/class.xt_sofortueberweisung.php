...
class xt_sofortueberweisung{
	...
	function pspRedirect($order_data) {
		...
		if (is_int($orders_id)) {
			$data['user_id'] = XT_SOFORTUEBERWEISUNG_USER_ID;
			$data['project_id'] = XT_SOFORTUEBERWEISUNG_PROJECT_ID;
			...
			'',   // user_variable_3 
 			'',   // user_variable_4 
 			'',   // user_variable_5 
			XT_SOFORTUEBERWEISUNG_PROJECT_PASSWORD  // project_password
			);
