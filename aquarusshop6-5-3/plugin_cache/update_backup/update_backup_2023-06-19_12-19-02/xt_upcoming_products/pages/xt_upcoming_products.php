...
if (XT_UPCOMING_PRODUCTS_ACTIVATED == 1
    &&
    (
        ($page->page_name == 'index' && ACTIVATE_XT_UPCOMING_PRODUCTS_START_PAGE == 1 ) ||
        ($page->page_name == 'xt_upcoming_products' && ACTIVATE_XT_UPCOMING_PRODUCTS_PAGE == 1 ) ||
    ...
    $tpl_data['total'] = $upcoming_products_page_data_array['total'];
    $tpl_data['show_more'] = ACTIVATE_XT_UPCOMING_PRODUCTS_PAGE == 1 && $upcoming_products_page_data_array['total'] > $limit;
...
}else if($page->page_name == 'xt_upcoming_products'){
