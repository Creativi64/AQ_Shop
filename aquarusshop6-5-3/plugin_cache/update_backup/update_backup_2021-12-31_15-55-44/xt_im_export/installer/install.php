...
$db->Execute("DELETE FROM ".TABLE_ADMIN_NAVIGATION." WHERE text in ('xt_im_export')");
...
$db->Execute("
		CREATE TABLE IF NOT EXISTS ".DB_PREFIX."_exportimport (
		  ...
		  `ei_store_id` int(11) NOT NULL DEFAULT 1,
		  PRIMARY KEY  (`id`)
		) ENGINE=".DB_STORAGE_ENGINE." AUTO_INCREMENT=1 ;");
