...
{
    $customer_group_discount = $_SESSION['customer_group_discount'];
    $this->data['customer_group_discount'] = $customer_group_discount;

    // calcMSPrice is set in product::getPrice
    if ($this->data['customer_group_discount'] && !$calcMsPrice)
    {
        global $price;
