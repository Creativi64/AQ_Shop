        ...
        $aTypesArray = array(
           ...
           array( // Individualfelder kapseln in Liste von einzlenen Individualfelder Obj
            ...
            array( // kundenpreis Liste
                ...
                'elements' => array(),
                'attrs' => array(
                    array('ref' => 'SOAP-ENC:arrayType', 'wsdl:arrayType' => 'tns:customerprice[]')),
                'arrayType' => 'tns:customerprice'),
            array(
                    'name' => 'customerprice',
                    'typeClass' => 'complexType',
                    'phpType' => 'struct',
                    ...
                    'restrictionBase' => '',
                    'elements' => array(
                        'quantity' => array('name' => 'status', 'type' => 'xsd:int'),
                        'price' => array('name' => 'price', 'type' => 'xsd:decimal'),
                        'date_available' => array('name' => 'date_available', 'type' => 'xsd:dateTime'),
                        'date_expired' => array('name' => 'date_expired', 'type' => 'xsd:dateTime'),
                    ),
                    'attrs' => array(),
                    'arrayType' => ''
                ),
            ...
            array(//begin- productFiles base
                    ...
                    'elements' =>
                    array(
                        'file_name' => array('name' => 'file_name', 'type' => 'xsd:string'), // name des Bildes
                        'file' => array('name' => 'file', 'type' => 'xsd:base64Binary'), // daten
                        'file_url' => array('name' => 'file_url', 'type' => 'xsd:int'), // Hash des gesendeten Bildes
                        'file_max_downloads' => array('name' => 'file_max_downloads', 'type' => 'xsd:int'), // URL zum Bild
                        'file_max_download_days' => array('name' => 'file_max_download_days', 'type' => 'xsd:int'), // URL zum Bild
                        'media_name'=>array('name' => 'media_name', 'type' => 'tns:langItem'),
                        'media_description'=>array('name' => 'media_description', 'type' => 'tns:langItem'),
