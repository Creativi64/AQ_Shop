...
/**
 * Diese Datei dient zu Teszwecken der Gewschwindigkeitsoptimierung
 *
 * Bennen SIe die original Datei config_caches.php um
 * und diese Datei in config_caches.php
 *
 */
 ...
 * Empfohlen: 'true'
 */
define('_SYSTEM_USE_DB_HOOKS', 'false');
