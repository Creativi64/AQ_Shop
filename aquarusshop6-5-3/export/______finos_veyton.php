...
/* **************************************** SPEICHERN *****************************************
                              XML für die Rückgabe an Finos generieren
********************************************************************************************* */
...
function save_products ()
{
  ...
  $header = '<?xml version="1.0" encoding="' . CHARSET . '"?>' . "\n" .
    ...
    $master_link = filter_input(INPUT_POST,'master_link');         //1=Haupt-Warengruppe; 0=zusätzliche Warengruppe
...
function save_products_images ()
{
  ...
  $header = '<?xml version="1.0" encoding="' . CHARSET . '"?>' . "\n" .
    ...
    $media_id = filter_input(INPUT_POST,'media_id');             //Webshop_ID aus zusätzlichen Bildern
   ...
   //Bild-Optionen laden
    ...
    else
    {
      ...
      if ($exists==0)        // Neuanlage
      {
          ...
          //Bild-Option kann nicht überarbeitet werden
          $Meldung = "Bild-Optionen können nicht aktualisiert werden, da diese nicht vorhanden sind.";
            ...
            $schema .= '<ORDER_INFO>' . "\n" .
                    ...
                    //Zahlungs-Informationen auswerten und ausgeben
                      switch ($orders['payment_code'])
                      {
                        ...
                        default:
                              // Keine der o.g. tritt für diese Bestellung zu
...
/* ********************************************* Löschen *****************************************
                                Werte im Shop aus Finos heraus löschen
************************************************************************************************ */
...
function delete_categories ()
{
  ...
  if (isset($categories_id))
  {
    ...
    //Kategorien in SEO-URL löschen (xt_seo_url -- DELETE FROM `xt_seo_url` where `link_type` = 2 and url_text = 'de/widerrufsrecht')
...
function delete_categories_all ()
{
  ...
  $header = '<?xml version="1.0" encoding="' . CHARSET . '"?>' . "\n" .
    ...
    //Kategorien in SEO-URL löschen (xt_seo_url -- DELETE FROM `xt_seo_url` where `link_type` = 2)
...
function delete_products_specials ()
{
  ...
  if (isset($specials_id))
  {
    ...
    // Sonderpreise zum Produkt löschen
...
function delete_products_cross_selling ()
{
  ...
  if (isset($products_id))
  {
    ...
    $schema = '<PRODUCTS_CROSS_SELLING_DATA>' . "\n" .
               ...
               '<PRODUCTS_ID>' . $products_id . '</PRODUCTS_ID>' . "\n" .
               '<ERROR>' . '0' . '</ERROR>' . "\n" .
               '<MESSAGE>' . 'Die Cross-Selling-Produkte zum Produkt wurden gelöscht' . '</MESSAGE>' . "\n" .
  ...
  else
  {
    ...
    $schema = '<PRODUCTS_CROSS_SELLING_DATA>' . "\n" .
               ...
               '<PRODUCTS_ID>' . $products_id . '</PRODUCTS_ID>' . "\n" .
               '<ERROR>' . '99' . '</ERROR>' . "\n" .
               '<MESSAGE>' . 'Die Cross-Selling-Produkte konnten nicht gelöscht werden' . '</MESSAGE>' . "\n" .
              '</PRODUCTS_CROSS_SELLING_DATA>' . "\n";
  }
...
function delete_products_cross_selling_all ()
{
  ...
  $header = '<?xml version="1.0" encoding="' . CHARSET . '"?>' . "\n" .
    ...
    // Cross-Selling-Produkte löschen
    ...
    $schema = '<PRODUCTS_CROSS_SELLING_DATA>' . "\n" .
               '<ACTION>' . $_GET['action'] . '</ACTION>' . "\n" .
               '<ERROR>' . '0' . '</ERROR>' . "\n" .
               '<MESSAGE>' . 'Es wurden alle Cross-Selling-Produkte zu den Produkten gelöscht' . '</MESSAGE>' . "\n" .
              '</PRODUCTS_CROSS_SELLING_DATA>' . "\n";
...
function delete_manufacturers ()
{
  ...
  if (isset($manufacturers_id))
  {
    ...
    $result2 = mysqli_query($db,"delete from " . TABLE_MANUFACTURERS_DESCRIPTION . " where manufacturers_id = '" . $manufacturers_id . "'");
      ...
      $schema = '<STATUS_DATA>' . "\n" .
                 ...
                 '<MANUFACTURERS_ID>' . $manufacturers_id . '</MANUFACTURERS_ID>' . "\n" .
                 '<ERROR>' . '0' . '</ERROR>' . "\n" .
                 '<MESSAGE>' . 'Der Hersteller wurde gelöscht' . '</MESSAGE>' . "\n" .
                '</STATUS_DATA>' . "\n";
  ...
  else
  {
      ...
      $schema = '<STATUS_DATA>' . "\n" .
                 ...
                 '<MANUFACTURERS_ID>' . $manufacturers_id . '</MANUFACTURERS_ID>' . "\n" .
                 '<ERROR>' . '99' . '</ERROR>' . "\n" .
                 '<MESSAGE>' . 'Der Hersteller konnte nicht gelöscht werden' . '</MESSAGE>' . "\n" .
                '</STATUS_DATA>' . "\n";
  }
        ...
        // Hersteller löschen
         ...
         $result2 = mysqli_query($db,"delete from " . TABLE_MANUFACTURERS_DESCRIPTION);
            ...
            $schema = '<STATUS_DATA>' . "\n" .
                        '<ACTION>' . $_GET['action'] . '</ACTION>' . "\n" .
                        '<ERROR>' . '0' . '</ERROR>' . "\n" .
                        '<MESSAGE>' . 'Alle Hersteller gelöscht' . '</MESSAGE>' . "\n" .
                      '</STATUS_DATA>' . "\n";
